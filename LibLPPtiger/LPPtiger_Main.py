...
class LPPtiger_Main(QtGui.QMainWindow, Ui_MainWindow):
    ...
    def b_run_hunter(self):
        ...
        self.ui.tab_b_rtstart_dspb.setValue(19.5)
        self.ui.tab_b_rtend_dspb.setValue(22.5)
        ...
        self.ui.tab_b_mzstart_dspb.setValue(845.0)
        self.ui.tab_b_mzend_dspb.setValue(847.0)
