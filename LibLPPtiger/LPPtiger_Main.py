...
class LPPtiger_Main(QtGui.QMainWindow, Ui_MainWindow):
    ...
    def b_run_hunter(self):
        ...
        self.ui.tab_b_sumxlsxpath_le.setText(r'D:\Project_lpptiger\output_sdf\CM_LPPs\PC\CM_PC_Lv1_prostane_only.xlsx')
        self.ui.tab_b_rtstart_dspb.setValue(24.25)
        ...
        self.ui.tab_b_score_spb.setValue(1.5)
        self.ui.tab_b_isotopescore_spb.setValue(80.0)
        self.ui.tab_b_mzstart_dspb.setValue(800.0)
        self.ui.tab_b_mzend_dspb.setValue(860.0)
